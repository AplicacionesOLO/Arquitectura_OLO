...
export function OLOArchView({ searchQuery="" }) {
  ...
  const nodes = {
    ...
    olo_api:      { id:"olo_api",      label:"OLO API",                x:632, y:498, w:72,  h:32, color:"#059669", bg:"#D1FAE5", desc:"OLO API — Gateway centralizado.\nSuscriptor del tópico de notificación (E3).\nConexión directa al SORTER CLIRO de Mecalux: órdenes de distribución por ruta/tienda (E6).\nConexión bidireccional con Azure (F1–F4):\nSRO · APOLLO · Última Milla · Liquidador de Viajes." },
    mecalux:      { id:"mecalux",      label:"Mecalux SORTER",         x:732, y:498, w:72,  h:32, color:"#D97706", bg:"#FEF3C7", desc:"Mecalux · SORTER CLIRO — clasificador (sorter) del cross-docking de EPA; no es un WMS (el WMS es eFlow).\nEn esta arquitectura objetivo recibe las órdenes de distribución por ruta/tienda (BLOQUE 7, conexión 23)." },
