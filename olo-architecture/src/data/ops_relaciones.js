...
export const OPS_RELACIONES = [
  { a: "WMS-D", b: "WMS-RF", status: "confirmed", que: "El escritorio genera las acciones de trabajo (Control › Acciones de Trabajo) que el handheld ejecuta en «Trabajo automático»: picking, reposición, almacenaje, despacho.", fuente: "Procedimientos CEDI (CEDI-05, CEDI-11, CEDI-12)" },
  { a: "WMS-D", b: "WMH", status: "confirmed", que: "eFlow envía las expediciones disponibles a Torre de Control; al crear el viaje, WMH devuelve el número de viaje (Viaje WM / NUMEROVIAJEWMH), la prioridad y la banda asignada.", fuente: "Mapeo funcional COFERSA · CEDI-01" },
  ...
  { a: "SORTER", b: "WMS-D", status: "confirmed", que: "Después de clasificar, el despacho a tienda de EPA sigue en CEDI-04 · Despacho EPA (Apolo + Carga Camión de eFlow).", fuente: "Procedimiento CEDI-04 · Manual SORTER" },
];
