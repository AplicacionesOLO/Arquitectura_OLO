...
export const CUESTIONARIO = [
  {
    ...
    preguntas: [
      { gap: "Accesos", p: "El refresco de permisos (25-sep-2026) devolvió la lectura de EFLOW_OLO, el histórico y los eIntegra de Costa Rica, pero SOFTLANDQA (QA VE, con las compañías Beval, Febeca, Sillaca, Trexa y Prisma) sigue sin acceso, igual que OLO_INTERFACE y el resto de Softland QA CR salvo MAR, y eFlow QA VE (EFLOW_BEVAL, EFLOW_FEBECA). ¿Pueden habilitarlos? La solicitud original también pedía Softland de producción (CR y VE) y Softland SCH CR, que no se entregaron.", va: "Monitor › Cambios en bases" },
      { gap: "Accesos", p: "Las bases QA_EFLOW_OLO, QA_EINTEGRA_CONFIG, OLO_CLIRO_EFLOW y HSAPRUEBA (QA CR) están fuera de línea: ¿es definitivo? ¿Dónde quedó el ambiente de QA de eFlow y del sorter?", va: "Monitor › Cambios en bases" },
      ...
      { gap: "GAP·04", p: "¿Existe un TMS para transporte internacional, un sistema aduanero (TICA) o un portal / EDI para clientes? Marca, dueño y cómo se conectan.", va: "Silos P1.9 Aduaneros y CEDI-01.17 Transporte internacional" },
  ...
  },
  {
    ...
    preguntas: [
      { gap: "Torre 4.6", p: "¿Con qué botón o acción de eFlow se envían los pedidos a la Torre de Control?", va: "Procesos › CEDI-01 Torre de Control Cofersa, paso correspondiente" },
      { gap: "Torre 4.9", p: "¿En qué columnas de eFlow se ven la prioridad, la banda asignada y el número de viaje?", va: "Procesos › CEDI-01, y manual de eFlow WMS" },
      { gap: "Torre 4.11", p: "¿Con qué botón se «generan» los pedidos desde Acciones de Trabajo y qué valor equivale a «prioridad alta»?", va: "Procesos › CEDI-01" },
      { gap: "Torre", p: "¿Qué significan los tipos de trabajo EXES, PICK, REPI, UBCO y UBRE?", va: "Contexto › Glosario" },
      { gap: "GAP·08", p: "El menú del handheld (v3.1.73.1) ya está mapeado. ¿Qué opciones dependen del perfil? El menú principal anuncia «ajustes, inventario inicial» y «Control palet», pero el usuario 886 no las ve.", va: "Operación › eFlow WMS · Handheld" },
      { gap: "GAP·08", p: "¿Qué hacen CROSS BANDA, MULTIPALET LIBRE, SEMIDIRIGIDO, PICKING INVERSO, TRANSFERENCIA STOCK, TRASLADO SUCURSAL y Creación Art. Zona Picking, y en qué casos las usa el CEDI? Ningún procedimiento de OLO las cita.", va: "Operación › eFlow WMS · Handheld · procesos de Almacenaje e Inventario" },
      { gap: "GAP·08", p: "¿Nos pueden compartir las pantallas de TRABAJO AUTOMÁTICO y TOMA FISICA y las que aparecen después de escanear (Ubicación de Palet, Picking, Artículos recepción, Finalizar Máster, Despachar máster completo)?", va: "Operación › eFlow WMS · Handheld" },
      { gap: "GAP·06", p: "¿Cuáles son las pantallas del cobro de almacenaje eInv (corte, estadía por palet, pre-proforma, factura)?", va: "Silo OL.6 Servicio logístico · procesos SLC" },
    ],
  },
  {
  ...
  },
  {
    ...
    preguntas: [
      ...
      { gap: "GAP·06", p: "¿Hay procedimiento aprobado para Servicios Especiales y los demás servicios de valor agregado?", va: "Silo CEDI-01.21 Valor agregado" },
    ],
  },
  {
