...
// Fuente: Softland ERP QA Venezuela · schema "SILLACA" (Sillaca) · SOFTLANDQA
// 150 tablas mostradas de 813 totales en el schema (filtradas por conectividad FK, top 150).

export const SFLSILLACA_COLORS = {
  "PAIS": "#475569",
  "ARTICULO": "#f39c12",
  "CLIENTE": "#27ae60",
  "FACTURA": "#16a085",
...
export const SFLSILLACA_TABLE_DEFS = {
  "PAIS": {
    "pk": "PAIS",
    "cols": [
      "PAIS",
...
export const SFLSILLACA_INTEGRATIONS = [];
