...
// Fuente: Softland ERP QA Venezuela · schema "BEVAL" (Beval) · SOFTLANDQA
// 150 tablas mostradas de 858 totales en el schema (filtradas por conectividad FK, top 150).

export const SFLBEVAL_COLORS = {
  "PAIS": "#475569",
  "ARTICULO": "#f39c12",
  "CLIENTE": "#27ae60",
  "FACTURA": "#16a085",
...
export const SFLBEVAL_MOD = new Set(["PAIS","ARTICULO","CLIENTE","FACTURA","PROVEEDOR","IMPUESTO","BODEGA","PEDIDO","ACTIVO_FIJO","VENDEDOR","ASIENTO_DE_DIARIO","CENTRO_CUENTA","DOCUMENTOS_CP","DOCUMENTOS_CC","ARTICULO_CUENTA","NIT","CUENTA_CONTABLE","CATEGORIA_CLIENTE","TIPO_ACTIVO","LOTE","LOCALIZACION","DIVISION_GEOGRAFICA2","CUENTA_BANCARIA","MONEDA","TIPO_ASIENTO","CENTRO_COSTO","DOCUMENTO_EMBARQUE","CATEGORIA_PROVEED","PAQUETE","RUBRO_FLUJO_CAJA","MOV_BANCOS","RETENCIONES","ACTIVO_MEJORA","CLASIFICACION","TIPO_PAGO","TIPOS_DETRACCIONES","ORDEN_COMPRA_LINEA","CALCULO_FLUJO_CAJA","CONDICION_PAGO","DOCS_SOPORTE","SERIE_CADENA","FACTURA_LINEA","EMBARQUE_LINEA","SUBTIPO_DOC_CC","SUBTIPO_DOC_CP","UNIDAD_DE_MEDIDA","GLOBALES_FA","NIVEL_PRECIO","TIPO_IMPUESTO","ORDEN_COMPRA","TIPO_DESCUENTO","VERSION_NIVEL","CAJA_CHICA","GLOBALES_AF","METODO_PAGO","SUBTIPO_DOC_CB","TIPO_INDICE_PRECIO","GLOBALES_CG","EMBARQUE","EXISTENCIA_BODEGA","TRANSACCION_INV","DEVOLUCION","LINEA_DOC_INV","CARTA_PORTE_MERCANCIA","CONCILIACION","TIPO_CAMBIO","ALARMA","DIFERIDO","FORMATO_TRANSFER","AJUSTE_CONFIG","ARTICULO_PRECIO","RESPONSABLE","LIQUIDAC_COMPRA","CHEQUE","DET_DOCUMENTO_EMBARQUE","DETALLE_RETENCION","DIVISION_GEOGRAFICA3","GLOBALES_CH","ITEMS_HACIENDA","MOV_REPORTADOS","COMPLEMENTO_SUNAT","CONSECUTIVO_CI","DETALLE_DIRECCION","ENTIDAD_FINANCIERA","GLOBALES_CO","PEDIDO_LINEA","PEDIDO_SUGERIDO","SUBSECCION_REPORTES","AUXILIAR_CC","AUXILIAR_CP","CARTA_PORTE_DOMICILIO","COBRADOR","CONCEPTO_VALE","CONSECUTIVO_FA","CUENTA_DEPRECIACIO","DEPARTAMENTO","DETALLE_FLUJO_CAJA","DETALLE_FLUJO_CAJA_EJECUTA","GLOBALES_CC","IMPUESTO_COMPRA","MODELO_RETENCION","SOLICITUD_OC","SOLICITUD_OC_LINEA","TRANSFERENCIA_CB","VALE","ALARMA_BASE_COLUMNA","ALARMA_PLANTILLA","ASIENTO_DISTRIBUID","AUDIT_TRANS_INV","BOLETA_INV_FISICO","CARTA_PORTE_UBICACION","HIST_DEPRECIACION","RECEPCION_DETRAC","TIPO_TARIFA_IVA","VERSION_FLUJO_CAJA","CLASIF_BIENES_SERV_ADQ","CODIGOS_MODIFICACION","CONSECUTIVO","DELETED_STATUS","DES_BON_REGLA","DEVOL_LIN_EMBARQUE","DOCUMENTO_INV","EXISTENCIA_RESERVA","FLUJO_CAJA","FORMATO","PERIODO_CONTABLE","SECCION_REPORTES","SOLICITUD_AF_NOTIF","TIPO_TRIBUTO","ACTIVO_DESMANTELAMIENTO","CAJA","CARTA_PORTE_OPERADOR","CONTRARECIBOS","CP_DET_RETENCION_PAR","DESPACHO_DETALLE","EXCEP_CIUDAD","EXCEPCION_ARANCEL_PAIS","MOV_BANCOS_RUBROS_CF","PISTA_EXISTEN_DET","ACTIVO_ACCION","ALARMA_BASE","ARTICULO_COMPRA","ASIENTO_MAYORIZADO","ASIENTO_RECURRENTE","ATRIBUTO","CARTA_PORTE_CVE_TRANSPORTE","CARTA_PORTE_ESTACIONES","CARTA_PORTE_TIPO_PERMISO","CATALOGO_EXISTENCIA","CODIGO_ARANCEL"]);

export const SFLBEVAL_GROUPS = {
  "as": {
...
export const SFLBEVAL_TABLE_DEFS = {
  "PAIS": {
    "pk": "PAIS",
    "cols": [
      "PAIS",
...
export const SFLBEVAL_INTEGRATIONS = [];
