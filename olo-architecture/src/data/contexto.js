...
export const APLICACIONES = [
  ...
  { nombre: "eflow WMS · RF (handheld)", version: "menú «eWMS - CEDI OLO»", tipo: "Terminal de piso", uso: "Recibo, almacenaje, picking, despacho, carga camión", fuente: "Capturas de los manuales CEDI", vista: { tab: "ops" } },
  ...
  { nombre: "Apolo", version: "app móvil", tipo: "Control de despacho EPA", uso: "Registro de tarimas con dos fotografías y control de lo que sale a tienda", fuente: "Procedimiento P4 · Despacho EPA", vista: { tab: "olo-arch", codigo: "P4" } },
  ...
  { nombre: "Excel / Drive", version: "—", tipo: "Controles manuales", uso: "Control diario de viajes, devoluciones, garantías, taller, cargas de contenedor", fuente: "Procedimientos P1, P4, P14", vista: { tab: "olo-arch", codigo: "P14" } },
];
...
export const CLIENTES = [
  { nombre: "COFERSA", codigo: "Compañía 0109 en eflow", color: "#1d4ed8",
    ...
    procesos: ["P1", "P5", "P6", "P7", "P8", "P10", "P9", "P11", "P12", "P14"] },
  { nombre: "Ferretería EPA", codigo: "Tiendas EPA", color: "#b45309",
    ...
    procesos: ["P2", "P3", "P4", "XDK-01", "XDK-02"] },
];

// Reglas operativas tomadas de los procedimientos (codigo → abre la ficha)
export const REGLAS_OPERATIVAS = [
  { regla: "Horario de corte: 3:30 p. m. para rutas GAM y 5:30 p. m. para rutas rurales.", cliente: "COFERSA", codigo: "P1" },
  { regla: "Todo pedido de COFERSA debe pasar por Torre de Control (la mercancía del mesanín va por la banda de su ruta y muelle).", cliente: "COFERSA", codigo: "P1" },
  { regla: "Se crean primero los viajes de rutas rurales y después los de GAM; no se mezclan rutas salvo que la observación del pedido lo permita.", cliente: "COFERSA", codigo: "P1" },
  { regla: "Todo viaje de material pesado se asigna a la puerta 29, sin importar la banda.", cliente: "COFERSA", codigo: "P1" },
  { regla: "Los pedidos incompletos por falta de stock se envían el mismo día con prioridad alta.", cliente: "COFERSA", codigo: "P1" },
  { regla: "Unidades pedidas, preparadas y chequeadas deben coincidir al 100 % (Comparación Alistó vs Packing).", cliente: "COFERSA", codigo: "P1" },
  { regla: "En el alisto no se combinan rutas dentro de un mismo pedido: el palet debe ser de la ruta asignada.", cliente: "COFERSA", codigo: "P5" },
  { regla: "La factura se envía a Hacienda antes de despachar; con la copia impresa el despacho queda habilitado.", cliente: "COFERSA", codigo: "P7" },
  { regla: "EPA no tiene banda ni mesanín: su alistamiento no pasa por Torre de Control.", cliente: "EPA", codigo: "P2" },
  { regla: "Programación semanal: los lunes ingresan todos los pedidos de tienda, con prioridad a los suministros.", cliente: "EPA", codigo: "P2" },
  { regla: "Una venta puntual (pagada por adelantado en tienda) tiene prioridad sobre cualquier otro pedido.", cliente: "EPA", codigo: "P2" },
  { regla: "El despacho a tiendas inicia diariamente a las 5:00 a. m.; cada tarima lleva dos fotografías (esquina y general) como respaldo ante reclamos.", cliente: "EPA", codigo: "P4" },
  { regla: "En cross-docking el avance mínimo aceptable del expediente en eflow es 99 %; el cliente decide si cierra el expediente con sobrantes o mermas.", cliente: "EPA", codigo: "P3" },
  { regla: "Los choferes con devoluciones llegan siempre a la puerta 10; sin boleta que coincida con lo entregado, no se recibe.", cliente: "COFERSA", codigo: "P14" },
  { regla: "Solo aplican para garantía las marcas Eagle, Bticino, Schneider, Lorenzetti, Coflex, Fanal, 3M y Henkel (acuerdo COFERSA–OLO).", cliente: "COFERSA", codigo: "P14" },
  { regla: "La mercancía de mesanín no se ingresa en el mismo palet que la de la zona baja.", cliente: "COFERSA", codigo: "P14" },
];
...
export const FUENTES = [
  ...
  { fuente: "Procedimientos operativos del CEDI", origen: "14 procedimientos · septiembre 2026", aporta: "Objetivo, alcance, responsables, pasos, registros y no conformidades de P1–P14", vista: { tab: "olo-arch" } },
