...
// Fuente: Softland ERP QA Venezuela · schema "FEBECA" (Febeca) · SOFTLANDQA
// 150 tablas mostradas de 884 totales en el schema (filtradas por conectividad FK, top 150).

export const SFLFEBECA_COLORS = {
  "PAIS": "#475569",
  "ARTICULO": "#f39c12",
  "CLIENTE": "#27ae60",
  "FACTURA": "#16a085",
...
export const SFLFEBECA_TABLE_DEFS = {
  "PAIS": {
    "pk": "PAIS",
    "cols": [
      "PAIS",
...
export const SFLFEBECA_INTEGRATIONS = [];
